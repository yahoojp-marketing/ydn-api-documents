...
<br>
【ターゲットリストについて】<br>
サイトを訪れたユーザーの閲覧履歴を指定した条件で振り分け、グルーピングできる機能です。<br>
これにより、訴求ポイントを絞り込んで、適切な広告の出し分けが可能になります。<br>
ターゲットリストには、以下の5つの種類があります。<br>
・サイトリターゲティングタグ発行時に自動で作成される“デフォルト”リスト<br>
・条件（URL、ラベル）を指定し、新たに作成するターゲットリスト<br>
・“デフォルト”リストや条件を指定して作成したターゲットリストを組み合わせた“コンビネーション”リスト<br>
・“デフォルト”リストや条件を指定して作成したターゲットリストと、ウェブ上の行動履歴が類似しているユーザーを抽出した“類似”リスト<br>
・Yahoo! DMPのデータを利用してYahoo!ディスプレイアドネットワーク（YDN）の広告を配信する際に必要な“カスタム”リスト<br>
<br><br>
【注意事項】<br>
・サイトリターゲティングタグは、1アカウントにつき「1個」発行可能です。<br>
・ターゲットリストは、1アカウントにつき最大300個まで設定可能です。<br>
・条件は1ターゲットリストあたり最大10個まで設定可能です。<br>
・ターゲットリストの組み合わせは、1ターゲットリストあたり最大10個まで設定可能です。<br>
・カスタムリストのご利用には、Yahoo! DMPのご契約が必要です。<br>
