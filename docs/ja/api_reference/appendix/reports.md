...
AGE                  | 年齢              | Age                                     | age                  | int | [AGEレスポンス](#age)
DAY                  | 日               | Daily                                   | day                  | string | -
DELIVER              | 広告掲載方式          | Ad Distribution                    | adDistribution       | string | [DELIVERレスポンス](#deliver)
...
AD_STYLE              | 掲載フォーマット（画像タイプ） | Ad Format Media Type | adStyle   | string | [AD_STYLEレスポンス](#ad_style)
...
AD_LAYOUT       | 広告レイアウト    | Ad Layout          | adLayout     | string    | [AD_LAYOUTレスポンス](#ad_layout)
IMAGE_OPTION       | 画像自動付与    | Dynamic Image Extensions          | dynamicImageExtensions     | string    | [IMAGE_OPTIONレスポンス](#image_option)
