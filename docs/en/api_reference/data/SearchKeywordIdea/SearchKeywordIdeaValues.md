...
SearchKeywordIdeaValues object is a container that includes keyword for search targeting.
### Service
...
| SearchKeyowrdIdeaValues|||
| searchKeywordIdea| <a href="./SearchKeywordIdea.md">SearchKeywordIdea</a>| Container that includes keyword for search targeting. |
