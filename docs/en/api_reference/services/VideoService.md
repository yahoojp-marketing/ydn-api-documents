...
|---|---|---|---|
| selector | required | [VideoSelector](../data/VideoSelector.md) | Retrieves the added video information. | 
...
|---|---|---|
| rval | [VideoPage](../data/VideoPage.md) | Container including operation results. | 
...
| uploadVideo | required | [UploadVideo](../data/UploadVideo.md) | Information of video to be uploaded.| 
...
| Parameter | Data Type | Description | 
|---|---|---|
| rval | [UploadUrlPage](../data/UploadUrlPage.md) | Container including operation results (list of all entities) of getUploadUrl method.| 
...
| Parameter | Requirement | Data Type | Description | 
|---|---|---|---|
| operations | required | [VideoOperation](../data/VideoOperation.md) | Operate (update) the video information. | 
...
| Parameter | Data Type | Description | 
|---|---|---|
| rval | [VideoReturnValue](../data/VideoReturnValue.md) | Container stores the operation result of mutate method. | 
...
| Parameter | Requirement | Data Type | Description | 
|---|---|---|---|
| operations | required | [VideoOperation](../data/VideoOperation.md) | Removes video files. | 
