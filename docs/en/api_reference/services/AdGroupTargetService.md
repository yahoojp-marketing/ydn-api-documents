...
| environment | url |
|---|---|
| production  | https://location.im.yahooapis.jp/services/V5.1/AdGroupTargetService?wsdl|
| sandbox  | https://sandbox.im.yahooapis.jp/services/V5.1/AdGroupTargetService?wsdl|
#### Namespace
