...
| environment | url |
|---|---|
| production  | https://location.im.yahooapis.jp/services/V201911/PlacementUrlListService?wsdl |
| sandbox  | https://sandbox.im.yahooapis.jp/services/V201911/PlacementUrlListService?wsdl |
#### Namespace
http://im.yahooapis.jp/V201911/PlacementUrlList
#### Service Overview
In PlacementUrlListService, acquiring, creating, updating and deleting Placement URL list will be done.
#### Operation
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <RequestHeader xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
  ...
  <SOAP-ENV:Body>
    <get xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
      <selector>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
      <ns2:service>PlacementUrlList</ns2:service>
      <ns2:requestTime>1574394440330</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
    <ns2:getResponse xmlns="http://im.yahooapis.jp/V201911" xmlns:ns2="http://im.yahooapis.jp/V201911/PlacementUrlList">
      <ns2:rval>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <SOAP-ENV:Body>
    <mutate xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList">
      <operations>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
      <ns2:service>PlacementUrlList</ns2:service>
      <ns2:requestTime>1574394440368</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
    <ns2:mutateResponse xmlns="http://im.yahooapis.jp/V201911" xmlns:ns2="http://im.yahooapis.jp/V201911/PlacementUrlList">
      <ns2:rval>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
      <ns2:service>PlacementUrlList</ns2:service>
      <ns2:requestTime>1574394440433</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://im.yahooapis.jp/V201911/PlacementUrlList" xmlns:ns2="http://im.yahooapis.jp/V201911">
      <ns2:service>PlacementUrlList</ns2:service>
      <ns2:requestTime>1574394440536</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
